...
public Action Command_HeroList(int client, int args)
{
	...
	char szBuffer[128];
	PrintToConsole(client, "-------------------------------------HELTE LIST--------------------------------------");
	for (int i = 0; i < g_iHeroCount; i++)
	{
...
{
	PrintToChat(client, "%t", "See Console", SH_PREFIX);
	PrintToConsole(client, "-------------------------------------KOMMANDOER-------------------------------------");
	PrintToConsole(client, "sm_help - Udskriver alle kommandoer i konsollen");
	PrintToConsole(client, "sm_superherohelp - Udskriver alle kommandoer i konsollen");
	PrintToConsole(client, "sm_herolist - Viser listen over tilgængelige helte");
	PrintToConsole(client, "sm_playerskills - Viser helte information om alle spillere");
	PrintToConsole(client, "sm_playerpowers - Viser helte information om alle spillere");
	PrintToConsole(client, "sm_playerheroes - Viser helte information om alle spillere");
	PrintToConsole(client, "sm_playerinfo - Viser alle spilleres superhelte information");
	PrintToConsole(client, "sm_myheroes - Viser de helte du har valgt og hvilken taster du har bundet");
	PrintToConsole(client, "sm_clearheroes - Anvendes til at fjerne alle valgte superhelte (i tilfældet af du gerne vil vælge andre helte)");
	PrintToConsole(client, "sm_clearpowers - Anvendes til at fjerne alle valgte superhelte (i tilfældet af du gerne vil vælge andre helte)");
	PrintToConsole(client, "sm_clearskills - Anvendes til at fjerne alle valgte superhelte (i tilfældet af du gerne vil vælge andre helte)");
	PrintToConsole(client, "sm_showmenu - Viser dig helte menuen i tilfældet af at du kan vælge en nye helte");
	PrintToConsole(client, "sm_heroes - Viser dig helte menuen i tilfældet af at du kan vælge en nye helte");
	PrintToConsole(client, "sm_heromenu - Viser dig helte menuen i tilfældet af at du kan vælge en nye helte");
	PrintToConsole(client, "sm_drophero - Anvendes når du gerne vil fjerne en specifik helt som du har valgt for at vælge en ny");
	PrintToConsole(client, "sm_drop - Anvendes når du gerne vil fjerne en specifik helt som du har valgt for at vælge en ny");
	PrintToConsole(client, "sm_whohas - Viser dig hvem der har den helt i det nuværende spil");
}
